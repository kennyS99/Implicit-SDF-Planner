...
public:
    ...
    void publishPointCloud(const std::vector<Eigen::Vector3d>& points, ros::Publisher& pub);
    void publishSinglePoint(const Eigen::Vector3d& point, ros::Publisher& pub);
...
#define STEP_HAVE_TARGET 2
    ...
    int step_state = STEP_HAVE_TARGET;
    ...
    ros::Publisher point_cloud_pub, point_pub;
